#!/bin/bash
# Morning Auto-Routine — runs daily (typically 6 AM local time) via Task Scheduler / cron
...
#
# Secrets loaded from .env file at project root. On macOS, Keychain is also checked.
...
# Secrets — load from .env file (Windows equivalent of macOS Keychain)
